...
import app.onbo.api.models.response.v2.menu.MenuVariant;
...
public class RadioGroupSection extends StatelessSection {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        for (int i = 0; i < menuVariants.get(position).getMenuVOptions().size(); i++) {
            ...
            btn.setText(String.format(context.getString(R.string.customization_sheet_cb_format),menuVariants.get(position).getMenuVOptions().get(i).getOptionName(),String.valueOf(menuVariants.get(position).getMenuVOptions().get(i).getPrice()*0.01)));
