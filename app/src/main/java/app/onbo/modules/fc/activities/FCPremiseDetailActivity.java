...
import app.onbo.root.activities.RestaurantDetailPresenter;
import app.onbo.root.adapters.MenuAdapterRestaurantDetail;
import butterknife.BindView;
import butterknife.ButterKnife;
import butterknife.OnClick;

public class FCPremiseDetailActivity extends AppCompatActivity implements FCViewContract.FCPremiseDetailView {


    public static final String TAG = FCPremiseDetailActivity.class.getSimpleName();
    ...
    @Inject
    FCPremisePresenter presenter;


    @OnClick(R.id.btn_start_order_fc)
    void call() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fc_premise_detail);
    ...
    public void redirectNonDineActivity(Restaurant restaurant) {
        Intent intent = new Intent(FCPremiseDetailActivity.this, NonDineActivity.class);
