...
import onbo.app.R;
import onbo.app.api.models.ItemHash;
...
import onbo.app.modules.dinein.adapters.MenuAdapter;
import onbo.app.modules.dinein.bottomsheets.DishReviewsSheetFragment;
import onbo.app.modules.dinein.bottomsheets.section_r_view.MenuItemCustomizationSheet;
import onbo.app.modules.dinein.callbacks.MenuItemClickListener;
import onbo.app.modules.dinein.callbacks.MenuItemOptionsSelected;
...
public class MenuItemsFragment extends Fragment
    ...
    public void onPlusButtonClicked(MenuItem menuItem, int num) {
        ...
        onbo.app.api.models.cart.MenuItem item = createCartMenuItemFromMenuItem(menuItem, menuVOptions, menuAddOns);
    ...
    public onbo.app.api.models.cart.MenuItem createCartMenuItemFromMenuItem(MenuItem item, List<MenuVOption> menuVOptions, List<MenuAddOn> menuAddOns) {
        return new onbo.app.api.models.cart.MenuItem(
                item.getItemId(),
                item.getItemName(),
                item.getDescription(),
                item.getItemPrice(),
    ...
    public ItemHash generateItemHash(onbo.app.api.models.cart.MenuItem cartMenuItem) {
    ...
    public int generateItemHashArray(onbo.app.api.models.cart.MenuItem cartMenuItem) {
    ...
    public void onOptionsSelected(MenuItem menuItem, List<MenuVOption> variantOptions, List<MenuAddOn> addOns) {
        ...
        onbo.app.api.models.cart.MenuItem item = createCartMenuItemFromMenuItem(menuItem, variantOptions, addOns);
        Log.d(TAG, "ADDED TO CART: " + menuItem.getItemName());
        ItemHash object = generateItemHash(item);
        Log.d(TAG, "ITEM_HASH: " + object.getItemHash());
        menuItemsPresenter.addItemToCart(item, object.getItemPrice(), object.getItemHash());
