...
import onbo.app.modules.dinein.adapters.CartItemsRecyclerAdapter;
import onbo.app.modules.dinein.callbacks.CartItemClickListener;
...
public class CartFragment extends Fragment implements DineInViewContract.CartFragmentView, CartItemClickListener {
    ...
    @Override
    public void onPlusButtonClicked(onbo.app.api.models.cart.MenuItem menuItem, int num) {
    ...
    @Override
    public void onMinusButtonClicked(onbo.app.api.models.cart.MenuItem menuItem, int num) {
        ItemHash object = generateItemHash(menuItem);
    ...
    @Override
    public void onCustomizableItemClicked(onbo.app.api.models.cart.MenuItem menuItem, int flag) {
        if (flag == 1) {
            ItemHash object = generateItemHash(menuItem);
            cartFragmentPresenter.addItemToCart(menuItem, object.getItemPrice(), object.getItemHash());
            Log.d(TAG, "ADDED TO CART: " + menuItem.getItemName());
